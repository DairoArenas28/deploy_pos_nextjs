...
const ShoppingCardContentsSchema = ProductSchema.pick({
  name: true,
  image: true,
  price: true,
  inventory: true
...
export const ShoppingCartSchema = z.array(ShoppingCardContentsSchema)
...
export type CartItem = z.infer<typeof ShoppingCardContentsSchema>
